...
static void mavlink_test_atmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_atmega_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.package_number = packet_in.package_number;
        packet1.time = packet_in.time;
        packet1.pressure = packet_in.pressure;
    ...
    mavlink_msg_atmega_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_atmega_pack(system_id, component_id, &msg , packet1.package_number , packet1.time , packet1.pressure , packet1.temperature , packet1.height , packet1.state );
    mavlink_msg_atmega_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_atmega_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.package_number , packet1.time , packet1.pressure , packet1.temperature , packet1.height , packet1.state );
    mavlink_msg_atmega_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_atmega_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_atmega_send(MAVLINK_COMM_1 , packet1.package_number , packet1.time , packet1.pressure , packet1.temperature , packet1.height , packet1.state );
    mavlink_msg_atmega_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
