...
typedef enum {
	...
	PRIM_RX		= 0 	//Режим работы (0 - режим передачи данных; 1 - режим приема данных) FIXME 0
 ...
 *  Параметры:
 *  	command - команда
 *  	buffer - буфер, куда записывается получаемое значение
 *  	buffer_length - длина буфера
 */
